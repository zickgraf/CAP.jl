...
#!  && only if every input object || morphism of the construction is well defined.
...
#!  For !writing this construction ⥉ every method, this function can be used to install
...
#!  InstallMethodWithToDoForIsWellDefined, then installs the ToDoListEntries, && then installs the
...
#!  ⥉ another way to ensure ToDoListEntries for IsWellDefined in the setter of an attribute.
